...
(function($){
    function _6b(_6c){
        ...
        bb.num.unbind(".pagination").bind("keypress.pagination",function(e){
            ...
            if(!(/[\d.]/.test(String.fromCharCode(e.keyCode)))){//限制输入页数输入非数字,lq20170522
                return false;
            }
        });
...
(function($){
    ...
    function _19b(_19c){
        ...
        if(opts.title&&!opts.noheader){
            var headerTitleDiv = '<img style="text-align:center;margin-top:-5px;" src="' + opts.titleImg + '"><span style="font-size:18px;color:#67B6E6;line-height:38px;font-weight:bold;margin-left:4px;margin-top:1px;">' + opts.title + '</span>';
            var _19e=$("<div class=\"panel-header\"><div class=\"panel-title\">" + headerTitleDiv + "</div></div>").prependTo(_19d);
            if(opts.iconCls){
...
(function($){
    ...
    function _3ae(_3af){
        ...
        if($.fn.combo){
            $(".combo-f",_3af).combo("_clear");
        }
        if($.fn.combobox){
            $(".combobox-f",_3af).combobox("_clear");
        }
        if($.fn.combotree){
            $(".combotree-f",_3af).combotree("_clear");
        }
        if($.fn.combogrid){
            $(".combogrid-f",_3af).combogrid("_clear");
        }
        _3b0(_3af);
    };
    function _3b1(_3b2){
...
(function($){
    ...
    function _4c2(_4c3,_4c4,_4c5){
        ...
        var tr=opts.finder.getTr(_4c3,_4c4);//去除选中效果
        if(tr.length){
    ...
    function _7f2(_7f3,_7f4){
        ...
        if(opts.mode=="h"){
            ...
            if(!isNaN(opts.width)){
                ...
                var len = _7f5.find("div.slider-rulelabel > span").length-1;
                var _7f5Text = _7f5.find("div.slider-rulelabel > span")[len].innerHTML;
                var num = Number(_7f5Text);
                $.each(_7f5.find("div.slider-rulelabel >span"),function(i,v){
                    v.style.color = "#fffffe";
                });

                if(num&&!isNaN(num)){
                }else{
                    if(_7f5Text === "不透明"){
                        _7f5.find("div.slider-rulelabel > span")[len].style.width = "60px";
                        //_7f5.find("div.slider-rulelabel")[0].all[len].clientWidth = "73px";
                        //_7f5.find("div.slider-rulelabel")[0].all[len].offsetWidth = "73px";
                        _7f5.find("div.slider-rulelabel > span")[len].style.color = "#fffffe";
                        _7f5.find("div.slider-rulelabel > span")[len].style.marginLeft = "-28px";
                    }
                }
                var _7f5Text2 = _7f5.find("div.slider-rulelabel > span")[0].innerHTML;
                num = Number(_7f5Text2);
                if(num&&!isNaN(num)){
                }
                else{
                    if(_7f5Text2 === "透明"){
                        _7f5.find("div.slider-rulelabel > span")[0].style.marginLeft = "-13px";
                    }
                }
            }
        }else{
