...
$(function () {
    ...
    setGridScrollHeight();
    $("#scrollDivOne,#scrollDivTwo").mCustomScrollbar({});//滚动条
    ...
    var queryPageData = function(bClickFilter){
        ...
        QueryObject.getTypeQuery(tabList, "canton3" , filterCondition, projectId, null,pageIndex-1, pageSize, bClickFilter, pagePagination);
    }
    ...
    $("#radius").keyup(function(){
        ...
        QueryObject.setRadius(radiusValue);
    });
    /**
     * 图层点击事件
     */
    ...
    $("#allAreaBtn").click(function () {
        ...
        var radius=$("#radius").val();
        var road = $(".trbg").html();
        var cc="canton3,"+road+","+radius;
        var cf=["US_PMATER","US_ATTACHMENT"];
        QueryObject.QuerySelectedArea("canton3", projectId, road, function(){
            classResList=StatisticsMgr.fieldClassification(thisSpatial,cf,null,null,"行政区统计图");
    ...
    var validation = function () {
        var road = $(".trbg").html();
        if ($(":checkbox:checked").length == 0||road==null) {
