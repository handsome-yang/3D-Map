 ...
 * 创建日期：2017年11月9日
 * 描    述：飞行路径的公共脚本
 * 注意事项：依赖jquery.js、xml2json.js、common.js
 * 遗留bug ：无
 * 修改日期：2017年11月9日
 */
...
STAMP.TrackManager = function(earth) {
    var trackManager = {};
    var xmlTrackListFile = earth.RootPath + top.STAMP_config.constants.TRACKFILE;
    var xmlAnimListFile = earth.RootPath + top.STAMP_config.constants.ANIMFILE;
