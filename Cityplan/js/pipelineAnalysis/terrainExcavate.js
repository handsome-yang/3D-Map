...
(function () {
    ...
    var showExcaveBalloon = function (excaveAmount) {
        var htmlStr = "";
        if (excaveBalloon) {
        ...
        var htmlStr = "<div style='color: "+fontColor+"; margin: 8; padding: 2px;font:14px Microsoft Yahei;'>" +
            "挖方量:<span style='font-weight:bold;color:"+ numColor +"'>" + excaveAmount + "</span>平方米</div>";
        var width = 250;
    ...
    /**
     * @param  {[object]} pFeat:画线返回的vector3s对象
     * @param  {[type]}
     * @return {[type]}
     */
    ...
    TerrainExcavate.showExcaveBalloon = showExcaveBalloon;
})();