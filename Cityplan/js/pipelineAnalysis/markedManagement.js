...
/**
 * 功能：标注树鼠标点击事件
 * 参数：event-JS事件；treeId-树的ID；node-选中的标注树节点
 * 返回：无
 */
var markedClick = function(event,treeId,treeNode){
    hiddenRightMenu();
};
...
var editMarkedClick = function(){
    ...
    var markedName = openDialog("markedNameDialog.html",params,250,100);
    if(markedName == null){
        return;
    }
